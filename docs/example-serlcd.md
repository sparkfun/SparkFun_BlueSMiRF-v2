...
-   <a href="https://learn.sparkfun.com/tutorials/avr-based-serial-enabled-lcds-hookup-guide/serial-uart-example-code---basic">
	<figure markdown>
	![AVR-Based Serial Enabled LCDs Hookup Guide](https://cdn.sparkfun.com/c/178-100/assets/learn_tutorials/7/8/9/serialbasichello.jpg)
	</figure>
...
<figure markdown>
[![BlueSMiRF v2 Connected to Serial Terminal and in Command Mode](./assets/img/example-terminal-command_mode.jpg){ width="600" }](./assets/img/example-terminal-command_mode.jpg "Click to enlarge")
...
<figure markdown>
[![Configuring the Baud Rate of the BlueSMiRF v2](./assets/img/example-terminal-at_command.jpg){ width="600" }](./assets/img/example-terminal-at_command.jpg "Click to enlarge")
<figcaption markdown>Configuring the Baud Rate of the BlueSMiRF v2</figcaption>
</figure>
...
With both boards powered, follow the steps to [pair and connect the two BlueSMiRFs together](operation_modes.md#pairing-mode). If all is well, you should see the RedBoard Plus transmitting the same message to the SerLCD. Instead of a wired connection, a pair of BlueSMiRF's were used!


<figure markdown>
[![Wireless Serial LCD](./assets/img/example-serlcd.jpg){ width="600" }](./assets/img/example-serlcd.jpg "Click to enlarge")
<figcaption markdown>Wireless Serial LCD with the RedBoard Plus</figcaption>
</figure>
