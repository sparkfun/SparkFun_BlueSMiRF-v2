...
<div style="text-align: center;">
	<table>
		...
		<tr>
			...
			<td style="text-align: center; border: solid 1px #cccccc;" bgcolor="#d4edda"><font color="#000000"><span STYLE="text-decoration:overline">RTS</span></font>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td style="text-align: center; border: solid 1px #cccccc;" bgcolor="#d4edda"><font color="#000000">CTS</font>
			</td>
			<td style="text-align: center; border: solid 1px #cccccc;" bgcolor="#d4edda"><font color="#000000"></font>
			</td>
...
!!! note
	The connection includes an additional connection for one pair of flow control pins: <span STYLE="text-decoration:overline">RTS</span> and CTS. This connection is not necessary.
...
<figure markdown>
[![USB-to-Serial Converter (CH340) to BlueSMiRF v2 Header with TX-to-RX and RX-to-TX](./assets/img/assembly-smd-uart_adapter.jpg){ width="600" }](./assets/img/assembly-smd-uart_adapter.jpg "Click to enlarge")
...
<figure markdown>
[![BlueSMiRF v2 Replacing Serial Connection on the Arduino Pro Mini 3.3V Serial Header Port](./assets/img/example-arduino_pro_mini.jpg){ width="600" }](./assets/img/example-arduino_pro_mini.jpg "Click to enlarge")
<figcaption markdown>BlueSMiRF v2 Replacing Serial Connection on the Arduino Pro Mini 3.3V Serial Header Port</figcaption>
</figure>


<figure markdown>
[![RedBoard IoT Development Board ESP32 Connected to the ZED-F9P with the BlueSMiRF v2 Connected to the ZED-F9P's RTCM Correction Port](./assets/img/example-iot_redboard-gnss.jpg){ width="600" }](./assets/img/example-iot_redboard-gnss.jpg "Click to enlarge")
<figcaption markdown>BlueSMiRF v2 Connected to the ZED-F9P's RTCM Correction Port</figcaption>
</figure>


<figure markdown>
[![High Precision GNSS UM980 with the BlueSMiRF v2 Connected to the UM980's RTCM Correction Port](./assets/img/example-gnss.jpg){ width="600" }](./assets/img/example-gnss.jpg "Click to enlarge")
