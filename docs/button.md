...
<figure markdown>
[![GIF Setting BlueSMiRF v2 in Pairing Mode](./assets/img/BlueSMiRF-_v2_Pair_Mode.gif){ width="600" }](./assets/img/BlueSMiRF-_v2_Pair_Mode.gif "Click to enlarge")
...
<figure markdown>
[![GIF Factory Reset](./assets/img/BlueSMiRF_V2_Factory_Reset_.gif){ width="600" }](./assets/img/BlueSMiRF_V2_Factory_Reset_.gif "Click to enlarge")
...
<figure markdown>
[![GIF Setting the BlueSMiRF in Bootloader Mode](./assets/img/BlueSMiRF_Bootloader_Mode_LED_Dim.gif){ width="600" }](./assets/img/BlueSMiRF_Bootloader_Mode_LED_Dim.gif "Click to enlarge")
