...
<figure markdown>
[![Second Serial Terminal](./assets/img/BlueSMiRF_v2_Serial_Terminal_1_b.JPG){ width="600" }](./assets/img/BlueSMiRF_v2_Serial_Terminal_1_b.JPG "Click to enlarge")
...
<figure markdown>
[![Sending Characters through First Terminal](./assets/img/BlueSMiRF_v2_Serial_Terminal_1_a.JPG){ width="600" }](./assets/img/BlueSMiRF_v2_Serial_Terminal_1_a.JPG "Click to enlarge")
<figcaption markdown>Sending Characters through First Terminal</figcaption>
</figure>


<figure markdown>
[![Receiving Characters through Second Terminal](./assets/img/BlueSMiRF_v2_Serial_Terminal_1_c.JPG){ width="600" }](./assets/img/BlueSMiRF_v2_Serial_Terminal_1_c.JPG "Click to enlarge")
...
<figure markdown>
[![Receiving Characters through First Serial TerminalSending Characters through First Terminal](./assets/img/BlueSMiRF_v2_Serial_Terminal_1_d.JPG){ width="600" }](./assets/img/BlueSMiRF_v2_Serial_Terminal_1_d.JPG "Click to enlarge")
<figcaption markdown>Receiving Characters through First Serial Terminal</figcaption>
</figure>


<figure markdown>
[![Sending Characters through Second Terminal](./assets/img/BlueSMiRF_v2_Serial_Terminal_1_c.JPG){ width="600" }](./assets/img/BlueSMiRF_v2_Serial_Terminal_1_c.JPG "Click to enlarge")
